...
Scratch files live in a Docker volume, including on Docker Desktop. Worker, proxy, broker and storage images use `linux/amd64`; ARM machines need Docker's amd64 emulation enabled.
