...
public class BuildScratchCleanerTests
{
    ...
    public async Task HostileTreeIsDeletedOnlyThroughHardenedContainer(bool useRunc)
    {
        ...
        var cleaner = CreateCleaner(useRunc);
        ...
        Assert.Contains($"--runtime {(useRunc ? "runc" : "runsc")}", create, StringComparison.Ordinal);
        ...
        Assert.Contains("--pids-limit 64", create, StringComparison.Ordinal);
    ...
    private static BuildScratchCleaner CreateCleaner(bool useRunc = false)
    {
